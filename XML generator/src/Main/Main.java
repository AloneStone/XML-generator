...
public class Main {
	...
	public static void main(final String[] args) {
			...
			node.add(A = new Node(1,new Position(25,25)));
			node.add(B = new Node(2,new Position(490,25)));
			node.add(C = new Node(3,new Position(940,25)));
			node.add(D = new Node(4,new Position(25,260)));
			node.add(E = new Node(5,new Position(490,260)));
			node.add(F = new Node(6,new Position(940,260)));
			node.add(G = new Node(7,new Position(25,500)));
			node.add(H = new Node(8,new Position(490,260)));
			node.add(I = new Node(9,new Position(940,260)));

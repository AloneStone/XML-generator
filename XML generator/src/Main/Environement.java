...
public class Environement {
	...
	public Environement(File picture, Collection<Signaling> signaling,
			ArrayList<Node> n, ArrayList<Arc> a) {
	...
	public String toString() {
		...
		return "Image : " + picture.getAbsolutePath() + "Nombre de noeud : "
				+ node.size() + "Nombre d'arcs : " + arc.size();
	}
